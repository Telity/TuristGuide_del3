...
class AttractionControllerTest {
    ...
    void saveAttraction() {
        ...
        doNothing().when(attractionService).addAttraction(attraction);

        //act
        String viewName = attractionController.saveAttraction(attraction);

        //assert
        assertEquals("redirect:/attractions", viewName);
        verify(attractionService).addAttraction(attraction);
    }
    ...
    void updateAttraction() {
        ...
        //assert
        assertEquals("redirect:/attractions", viewName);
        verify(attractionService).updateAttraction(attraction, tagIds);
    }
}